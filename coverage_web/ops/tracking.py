...
Kept deliberately dumb — a context manager writing two rows' worth of
timestamps, nothing else — because the six commands it wraps
(gmail_backfill, gmail_watch_renew, refresh, send_deadline_push_alerts,
send_weekly_digest, pro_trial_expire) already have their own retry/failure
