...
_INSIGHT = _rx(
    ...
    r"|series|session|forum|summit|workshop|symposium)",
    ...
    # Citi's whole student-events board is "Career Insights: Meet the Business
    # — Banking (NAM Session)" (17 live rows). The colon is what kept these
    # out of the qualifier list above.
    r"\bcareer\s+insights?\b",
